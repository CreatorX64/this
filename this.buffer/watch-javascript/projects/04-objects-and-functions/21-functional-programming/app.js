...
// These functional programming languages includes Lisp, Scheme, or ML. These are
// langauges that have first class functions, functions that behave os objects
// which you can pass as parameters, or return them from other functions. Having
// first class functions in JavaScript programming language means that we can
// implement something called "functional programming" where we think and code in
// terms of functions. This introduces and entirely different way of thinking and
...
// One other note about function programming is that your functions, especially
...
// First class functions and functional programming in JavaScript is really what
