...
// The reason that they all have reference to the same outer lexical environment
// is because of the fact that they all were created in the same execution context
fs[0]();  // Prints "3"
fs[1]();  // Prints "3"
fs[2]();  // Prints "3"


// What if we wanted the above lines to actually print 0, 1, 2? Using IIFEs in ES5
...
// What if we wanted the above lines to actually print 0, 1, 2? Using let in ES6
...
function buildFunctions3() {
  ...
  // include in its variable environment the variable "i" in the specific value
  // that it had when the function was created in that specific block scope.
  // In effect, each function's reference to the "i" variable will be at different
  // memory addresses
  for (let i = 0; i < 3; i++) {
    arr.push(
      function () {
