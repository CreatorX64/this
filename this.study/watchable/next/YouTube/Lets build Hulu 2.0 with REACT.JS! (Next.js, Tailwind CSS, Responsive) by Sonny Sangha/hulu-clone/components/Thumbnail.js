...
const Thumbnail = ({ result }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="group p-2 transition duration-200 ease-in cursor-pointer sm:hover:scale-105 sm:hover:z-50"
    >
      <Image
        layout="responsive"
        src={
      ...
      <div className="p-2">
        ...
        <h2 className="mt-1 text-2xl transition duration-100 ease-in-out text-white sm:group-hover:font-bold">
